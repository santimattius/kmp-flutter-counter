...
package kmp_flutter_counter.android_app.generated.resources
...
internal object Res {
  ...
  public suspend fun readBytes(path: String): ByteArray =
      readResourceBytes("composeResources/kmp_flutter_counter.android_app.generated.resources/" +
      path)
  ...
  public fun getUri(path: String): String =
      getResourceUri("composeResources/kmp_flutter_counter.android_app.generated.resources/" + path)
